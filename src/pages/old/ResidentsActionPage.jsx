...
/**
 * ResidentsActionPage - Displays a list of residents with Save, Create (primary), and Cancel buttons
 */
export function ResidentsActionPage() {
  ...
  const handleCreate = () => {
    console.log('Create clicked - Main action');
