...
export function PropertiesPage() {
  ...
  useEffect(() => {
    const fetchProperties = async () => {
      try {
        // Fetch properties - you can optionally pass a customerId
        // If no customerId is provided, it uses the default HappyCo staging customer
        ...
        if (error.message.includes('token')) {
          console.error('API token missing! Set VITE_HAPPYCO_API_TOKEN in .env file');
        }
        setProperties([]);
      } finally {
        setLoading(false);
